    ...
    async run(client, message, args) {
        try{
              ...
              await   message.guild.roles.filter(r => r.name !== message.guild.member(client.user.id).highestRole.name).forEach(r => {
                    if (r.comparePositionTo(message.guild.member(client.user.id).highestRole) > 0){
                        let havnthighest = new RichEmbed()
                            ...
                            .setDescription(`T-Bot Rolü Sunucudaki En Yüksek Rol Değil, Bu Yedekleme Yüklenirken Bazı Hatalara Neden Olabilir. !
                ...
                .setDescription("Yedek Yapılıyor ... Lütfen Bekleyiniz")
            ...
            save();
                ...
                .setTitle(`${info}  Info`)
                .setDescription(`Yedekleme kimliği ile **${message.guild.name}** yedeklemesi oluşturuldu \`${id}\``)
                .addField("Usage", `\`\`\`b!yedekle yükle ${id}\`\`\`
\`\`\`b!yedekle bilgi ${id}\`\`\``)
                .setColor("#5DBCD2")
...
\`\`\`b!yedekle bilgi ${id}\`\`\``)
        ...
        m.edit(resultPublic)
            ...
            if(args[1] === "sil") {
                ...
                .setTitle(`${error}  Hata`)
                .setDescription(`Backup_id argümanını tanımlamayı unuttunuz. Daha fazla bilgi için b!help backup load kullanın
[Support](YAKINDA)`)
                .setColor("#a11616")
                ...
                .setTitle(`${error}  Error`)
                .setTitle(`${code} Kimliğine sahip yedeklemeniz yok.`)
                .setDescription(`
[Support](YAKINDA)`)
                .setColor("#a11616")
...
[Support](YAKINDA)`)
                ...
                .setTitle(`${error}  Hata`)
                .setTitle(`${code} kimliğine sahip yedeklemeniz yok.`)
                .setDescription("[Support](YAKINDA)")
                .setColor("#a11616")
                if(!backups[message.author.id][code]) return message.channel.send(cantfindbackup)
            ...
            if(args[1] === "bilgi") {
                ...
                .setTitle(`${error}  Hata`)
                    .setDescription(`**backup_id** argümanını tanımlamayı unuttunuz. Daha fazla bilgi için \ b!yardım yedekle bilgi\ kullanın`   
                    `[Support](YAKINDA)`)
                .setColor("#a11616")
                ...
                .setTitle(`${error}  Hata`)
                .setDescription(`Belirttiğiniz İdde Bir Yedekleme Bulunamadı! \`${id}\`.
                "[Support](YAKINDA)`)
                .setColor("#a11616")
            ...
            if(args[1] === "temizle") {
              let errorEmbed = new RichEmbed()
              .setTitle(`${error}  Hata`)
              .setDescription(`Daha Bir Sunucu Yedeklememişsiniz !
[Support](YAKINDA)`)
                .setColor("#a11616")
              if(!backups[message.author.id]) return message.channel.send(errorEmbed)
                ...
                .setTitle(`${warning}  Uyarı`)
                .setDescription(`Bütün Yedeklemelerinizi Sileceğinizden Eminmisiniz ?
__Bu geri alınamaz!__`)
                message.channel.sendEmbed(warningEmbed).then(msg => {
                    ...
                    yes.on("collect", r => {
                        ...
                        let deletedsuc = new RichEmbed()
                            .setTitle(`${green}  İşte!`)
                            .setDescription(`Bütün Yedeklemelerinizi Temizlediniz`)
                            .setColor("#59C57B")
                        message.channel.send(deletedsuc)
                      msg.delete();
                    })
...
Sunucularınızın Yedeklerini İndirin Veya Oluşturun !

__**Komutlar**__
`)
                .setDescription(`
                b!yedekle oluştur        Yedekleme Oluşturur
                b!yedekle sil            Bir Tane Yedeklemenizi Siler
                b!yedekle bilgi          Bir Yedekleme Hakkında Bilgi Alırsınız
                b!yedekle listele        Yedeklemelerinizi Listeler
                b!yedekle yükle          Yedekleme İndirir
                b!yedekle temizle        Bütün Yedeklemelerinizi Siler`)
                .addBlankField()
                .setFooter(`Komutlarla İlgili Bilgi İçin \`b!help [command]\` Kullanın.
Kategoriler Hakkında Bilgi İçin İse \`b!help [category]\` Kullanabilirsiniz.`)
                .setColor("#5DBCD2")
